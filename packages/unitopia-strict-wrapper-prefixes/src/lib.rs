...
macro_rules! impl_prefix_mul_add_traits {
    ($prefix:ident) => {
        impl<T, Rhs, OutValue> num_traits::MulAdd<Rhs, unitopia_measure::Measure<unitopia_measure::MulUnit<<T as unitopia_strict_wrapper_units::StrictWrapperUnit>::Unit, Rhs::Unit>, OutValue>> for $prefix<T>
        where
            Rhs: unitopia_strict_wrapper_units::StrictWrapperUnit,
            T: unitopia_strict_wrapper_units::StrictWrapperUnit,
            T: num_traits::MulAdd<Rhs, unitopia_measure::Measure<unitopia_measure::MulUnit<<T as unitopia_strict_wrapper_units::StrictWrapperUnit>::Unit, Rhs::Unit>, OutValue>, Output = unitopia_measure::Measure<unitopia_measure::MulUnit<<T as unitopia_strict_wrapper_units::StrictWrapperUnit>::Unit, Rhs::Unit>, OutValue>>,
        {
            type Output = unitopia_measure::Measure<unitopia_measure::MulUnit<<T as unitopia_strict_wrapper_units::StrictWrapperUnit>::Unit, Rhs::Unit>, OutValue>;

            fn mul_add(self, a: Rhs, b: unitopia_measure::Measure<unitopia_measure::MulUnit<<T as unitopia_strict_wrapper_units::StrictWrapperUnit>::Unit, Rhs::Unit>, OutValue>) -> Self::Output {
